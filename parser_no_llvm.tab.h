...
#ifndef YY_YY_PARSER_NO_LLVM_TAB_H_INCLUDED
# define YY_YY_PARSER_NO_LLVM_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 42 "parser_no_llvm.y"

    char *str;
    int num;
    int op;  // Changed from op_type to int for compatibility

#line 101 "parser_no_llvm.tab.h"
...
#endif /* !YY_YY_PARSER_NO_LLVM_TAB_H_INCLUDED  */
