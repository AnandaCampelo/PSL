...
static const yytype_int16 yyrline[] =
{
      ...
      98,    99,   100,   104,   115,   126,   143,   152,   163,   168,
     178,   191,   191,   196,   207,   220,   225,   235,   245,   255,
     265,   275,   285,   295,   309,   308,   355,   359,   364,   372,
     376,   384,   400,   404,   412,   428,   446,   464,   475,   480,
     512,   527,   542,   561,   560,   578,   577
};
#endif
...
#line 1266 "parser_no_llvm.tab.c"
    break;

  case 24: /* subtitulo_block: SUBTITULO INDENTED_TEXT NEWLINE  */
#line 116 "parser_no_llvm.y"
    { 
        printf("## %s\n\n", (yyvsp[-1].str));
...
#line 1278 "parser_no_llvm.tab.c"
    break;

  case 25: /* paragrafo_block: PARAGRAFO indented_lines  */
#line 127 "parser_no_llvm.y"
    { 
...
#line 1296 "parser_no_llvm.tab.c"
    break;

  case 26: /* indented_lines: INDENTED_TEXT NEWLINE  */
#line 144 "parser_no_llvm.y"
    { 
        if (paragraph_text) {
            free(paragraph_text);
            paragraph_text = NULL;
...
#line 1321 "parser_no_llvm.tab.c"
    break;

  case 28: /* lista_block: LISTA lista_items  */
#line 164 "parser_no_llvm.y"
    { printf("\n"); }
#line 1327 "parser_no_llvm.tab.c"
    break;

  case 29: /* lista_items: INDENTED_TEXT NEWLINE  */
#line 169 "parser_no_llvm.y"
    { 
        printf("- %s\n", (yyvsp[-1].str));
...
#line 1341 "parser_no_llvm.tab.c"
    break;

  case 30: /* lista_items: lista_items INDENTED_TEXT NEWLINE  */
#line 179 "parser_no_llvm.y"
    { 
        printf("- %s\n", (yyvsp[-1].str));
...
#line 1355 "parser_no_llvm.tab.c"
    break;

  case 31: /* $@2: %empty  */
#line 191 "parser_no_llvm.y"
             { enum_count = 1; }
#line 1361 "parser_no_llvm.tab.c"
    break;

  case 32: /* enumerar_block: ENUMERAR $@2 enumerar_items  */
#line 192 "parser_no_llvm.y"
    { printf("\n"); }
#line 1367 "parser_no_llvm.tab.c"
    break;

  case 33: /* enumerar_items: INDENTED_TEXT NEWLINE  */
#line 197 "parser_no_llvm.y"
    { 
        printf("1. %s\n", (yyvsp[-1].str));
        enum_count = 2;
...
#line 1396 "parser_no_llvm.tab.c"
    break;

  case 35: /* tarefas_block: TAREFAS tarefas_items  */
#line 221 "parser_no_llvm.y"
    { printf("\n"); }
#line 1402 "parser_no_llvm.tab.c"
    break;

  case 36: /* tarefas_items: STATUS_S NEWLINE  */
#line 226 "parser_no_llvm.y"
    { 
        printf("- [x] %s\n", (yyvsp[-1].str));
...
#line 1416 "parser_no_llvm.tab.c"
    break;

  case 37: /* tarefas_items: STATUS_N NEWLINE  */
#line 236 "parser_no_llvm.y"
    { 
        printf("- [ ] %s\n", (yyvsp[-1].str));
...
#line 1430 "parser_no_llvm.tab.c"
    break;

  case 38: /* tarefas_items: STATUS_SIM NEWLINE  */
#line 246 "parser_no_llvm.y"
    { 
        printf("- [x] %s\n", (yyvsp[-1].str));
...
#line 1444 "parser_no_llvm.tab.c"
    break;

  case 39: /* tarefas_items: STATUS_NAO NEWLINE  */
#line 256 "parser_no_llvm.y"
    { 
        printf("- [ ] %s\n", (yyvsp[-1].str));
...
#line 1458 "parser_no_llvm.tab.c"
    break;

  case 40: /* tarefas_items: tarefas_items STATUS_S NEWLINE  */
#line 266 "parser_no_llvm.y"
    { 
        printf("- [x] %s\n", (yyvsp[-1].str));
...
#line 1472 "parser_no_llvm.tab.c"
    break;

  case 41: /* tarefas_items: tarefas_items STATUS_N NEWLINE  */
#line 276 "parser_no_llvm.y"
    { 
        printf("- [ ] %s\n", (yyvsp[-1].str));
...
#line 1486 "parser_no_llvm.tab.c"
    break;

  case 42: /* tarefas_items: tarefas_items STATUS_SIM NEWLINE  */
#line 286 "parser_no_llvm.y"
    { 
        printf("- [x] %s\n", (yyvsp[-1].str));
...
#line 1500 "parser_no_llvm.tab.c"
    break;

  case 43: /* tarefas_items: tarefas_items STATUS_NAO NEWLINE  */
#line 296 "parser_no_llvm.y"
    { 
        printf("- [ ] %s\n", (yyvsp[-1].str));
...
#line 1514 "parser_no_llvm.tab.c"
    break;

  case 44: /* $@3: %empty  */
#line 309 "parser_no_llvm.y"
    { 
...
#line 1533 "parser_no_llvm.tab.c"
    break;

  case 45: /* codigo_block: CODIGO $@3 codigo_content  */
#line 324 "parser_no_llvm.y"
    { 
...
#line 1636 "parser_no_llvm.tab.c"
    break;

  case 55: /* nota_block: NOTA indented_lines  */
#line 429 "parser_no_llvm.y"
    {
        if (paragraph_text) {
            printf("> *Note:* %s\n\n", paragraph_text);
...
#line 1655 "parser_no_llvm.tab.c"
    break;

  case 56: /* citacao_block: CITACAO indented_lines  */
#line 447 "parser_no_llvm.y"
    {
        if (paragraph_text) {
            printf("> %s\n\n", paragraph_text);
...
#line 1674 "parser_no_llvm.tab.c"
    break;

  case 57: /* divisor_block: DIVISOR NEWLINE  */
#line 465 "parser_no_llvm.y"
    { 
        printf("---\n\n");
...
#line 1686 "parser_no_llvm.tab.c"
    break;

  case 58: /* tabela_block: TABELA cabecalho_line tabela_rows  */
#line 476 "parser_no_llvm.y"
    { printf("\n"); }
#line 1692 "parser_no_llvm.tab.c"
    break;

  case 59: /* cabecalho_line: CABECALHO NEWLINE  */
#line 481 "parser_no_llvm.y"
    {
...
#line 1725 "parser_no_llvm.tab.c"
    break;

  case 60: /* tabela_rows: INDENTED_TEXT NEWLINE  */
#line 513 "parser_no_llvm.y"
    {
        char *s = strdup((yyvsp[-1].str));
        char *token, *saveptr;
...
#line 1744 "parser_no_llvm.tab.c"
    break;

  case 61: /* tabela_rows: tabela_rows INDENTED_TEXT NEWLINE  */
#line 528 "parser_no_llvm.y"
    {
        char *s = strdup((yyvsp[-1].str));
        char *token, *saveptr;
...
#line 1763 "parser_no_llvm.tab.c"
    break;

  case 62: /* tabela_rows: tabela_rows INDENTED_TEXT  */
#line 543 "parser_no_llvm.y"
    {
...
#line 1782 "parser_no_llvm.tab.c"
    break;

  case 63: /* $@4: %empty  */
#line 561 "parser_no_llvm.y"
    {
...
#line 1794 "parser_no_llvm.tab.c"
    break;

  case 64: /* se_block: SE $@4 block  */
#line 569 "parser_no_llvm.y"
    {
        // Finalizar a estrutura condicional
        if (0) {
        }
    }
#line 1804 "parser_no_llvm.tab.c"
    break;

  case 65: /* $@5: %empty  */
#line 578 "parser_no_llvm.y"
    {
...
#line 1816 "parser_no_llvm.tab.c"
    break;

  case 66: /* repetir_block: REPETIR $@5 block  */
#line 586 "parser_no_llvm.y"
    {
        // Finalizar a estrutura de repetição
        if (0) {
        }
    }
#line 1826 "parser_no_llvm.tab.c"
    break;


#line 1830 "parser_no_llvm.tab.c"
